      ...
      <main className="container mx-auto px-4 py-10 max-w-2xl">
        <div className="flex flex-col items-center text-center py-16">
          ...
          <p className="text-muted-foreground font-sans mb-6">
            Your vendor account is active. Manage your store and products from
            the dashboard.
          </p>
      ...
      <main className="container mx-auto px-4 py-10 max-w-2xl">
        <div className="flex flex-col items-center text-center py-16">
          ...
          <p className="text-muted-foreground font-sans mb-6 max-w-sm">
            Your vendor registration is pending admin review. You'll be able to
            access your store once approved.
          </p>
          <Button
            asChild
            variant="outline"
            className="border-gold/30 text-bronze hover:bg-gold/5"
          >
