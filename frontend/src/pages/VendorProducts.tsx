  ...
  if (!identity) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">Please sign in to manage your products.</p>
  ...
  if (!isApproved) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">Your vendor account must be approved before you can manage products.</p>
        <Button variant="outline" onClick={() => navigate({ to: '/' })}>Go Home</Button>
      </div>
    );
  }
  ...
  if (!storedVendorId) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6">Please register your store first.</p>
        <Button onClick={() => navigate({ to: '/vendor/register' })}>Register Store</Button>
      </div>
    );
  }
