...
export default function MyOrders() {
  ...
  const sorted = [...(orders ?? [])].sort((a: LocalOrder, b: LocalOrder) => b.createdAt - a.createdAt);
  ...
  if (sorted.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center">
        ...
        <Button onClick={() => navigate({ to: '/products' })}>Start Shopping</Button>
      </div>
    );
  }
          ...
          >
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <Button
                ...
                variant="ghost"
                onClick={() =>
                  navigate({ to: '/orders/$orderId/receipt', params: { orderId: order.id } })
                }
              >
