...
export default function Cart() {
  ...
  const [resolvedProducts, setResolvedProducts] = React.useState<Map<string, Product>>(new Map());
  ...
  const handleProductResolved = React.useCallback((productId: string, product: Product | null) => {
    if (product) {
