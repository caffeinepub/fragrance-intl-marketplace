...
export default function Footer() {
  ...
  const appId = encodeURIComponent(window.location.hostname || 'fragrance-intl');
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground font-sans leading-relaxed max-w-xs">
              A curated multi-vendor marketplace for the world's finest fragrances.
            </p>
          </div>

          {/* Links */}
          <div className="space-y-3">
            <h4 className="font-serif text-sm text-foreground uppercase tracking-widest">Marketplace</h4>
          ...
          {/* Legal */}
          <div className="space-y-3">
            <h4 className="font-serif text-sm text-foreground uppercase tracking-widest">Legal</h4>
            <ul className="space-y-2">
              {['Terms of Service', 'Privacy Policy', 'Cookie Policy'].map((item) => (
                <li key={item}>
                  <span className="text-sm text-muted-foreground font-sans cursor-default">{item}</span>
                </li>
              ))}
            </ul>
          </div>
